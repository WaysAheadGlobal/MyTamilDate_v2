...
profile.post('/contact', [
    ...
    VALUES (?, ?, ?, ?, NOW(), NOW())
  `;
    db_1.db.query(query, [email, name, message, issue], (err, results) => {
        if (err) {
...
profile.get('/', verifyUser_1.verifyUser, (req, res) => {
...
profile.get('/approval/:id', verifyUser_1.verifyUser, (req, res) => {
...
profile.post('/updateemail', verifyUser_1.verifyUser, [
    body('email').isEmail().withMessage('Invalid email address')
], (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
    ...
    db_1.db.query(checkEmailQuery, [email], (err, results) => {
        if (err) {
        ...
        db_1.db.query(updateQuery, [email, userId], (err, updateResults) => {
            if (err) {
            ...
            db_1.db.query(selectQuery, [userId], (err, updatedResults) => {
                if (err) {
...
profile.put('/namedetails', [
    ...
    const query = `
      ...
      WHERE user_id = ?
    `;
    db_1.db.query(query, [first_name, last_name, birthday, userId], (err, results) => {
        if (err) {
...
profile.put('/brithday', [
    ...
    const query = `
      ...
      WHERE user_id = ?
    `;
    db_1.db.query(query, [birthday, userId], (err, results) => {
        if (err) {
            console.error('Error updating user profile:', err);
            return res.status(500).send('Internal Server Error');
        }
...
profile.get('/namedetails', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    const query = `
...
profile.put('/gender', [
    ...
    const query = `
      ...
      WHERE user_id = ?
    `;
    db_1.db.query(query, [gender, want_gender, userId], (err, results) => {
        if (err) {
            console.error('Error updating user profile:', err);
            return res.status(500).send('Internal Server Error');
        }
...
profile.post('/language', [
    ...
    db_1.db.query(deleteQuery, [userId], (err) => {
        if (err) {
        ...
        const values = languages.map((languageId) => [userId, languageId, new Date(), new Date()]);
        db_1.db.query(insertQuery, [values], (err) => {
            if (err) {
...
profile.get('/userlanguage', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    const query = `
...
profile.get('/gender', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    const query = `
...
profile.post('/locations', [
    ...
    db_1.db.query(query, [location_id, userId], (err, results) => {
        if (err) {
...
profile.get('/locations', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    const query = `
...
profile.get('/location-options', verifyUser_1.verifyUser, (req, res) => {
    ...
    db_1.db.query(query, (err, results) => {
        ...
        const locations = results.reduce((acc, location) => {
...
profile.post('/religions', [
    ...
    db_1.db.query(updateUserProfileQuery, [religionId, userId], (err, updateResults) => {
        if (err) {
            console.error('Error updating user profile:', err);
            return res.status(500).json({ message: 'Internal Server Error' });
        }
...
profile.get('/religions', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    ...
    db_1.db.query(getAllReligionsQuery, (err, religions) => {
        if (err) {
            console.error('Error fetching religions:', err);
            return res.status(500).json({ message: 'Internal Server Error' });
        }
        db_1.db.query(getUserReligionQuery, [userId], (err, userReligionResults) => {
            if (err) {
...
profile.get('/growths-options', (req, res) => {
    db_1.db.query('SELECT name, id FROM growths', (err, results) => {
        if (err) {
...
profile.get('/growths', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
...
profile.post('/growths', [
    ...
    db_1.db.query(updateUserProfileQuery, [growthId, userId], (err, updateResults) => {
        if (err) {
            console.error('Error updating user profile:', err);
            return res.status(500).json({ message: 'Internal Server Error' });
        }
...
profile.post('/studies', [
    ...
    db_1.db.query(query, [name], (err, results) => {
        if (err) {
        ...
        db_1.db.query(updateUserProfileQuery, [studyId, userId], (err, updateResults) => {
            if (err) {
                console.error('Error updating user profile:', err);
                return res.status(500).json({ message: 'Internal Server Error' });
            }
...
profile.get('/studies', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
...
profile.get('/jobs', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
...
profile.post('/jobs', [
    ...
    db_1.db.query(query, [name], (err, results) => {
        ...
        db_1.db.query(updateUserProfileQuery, [jobId, userId], (err, updateResults) => {
            if (err) {
                console.error('Error updating user profile:', err);
                return res.status(500).json({ message: 'Internal Server Error' });
            }
...
profile.get('/kids-family', verifyUser_1.verifyUser, (req, res) => {
    db_1.db.query('SELECT want_kid_id, have_kid_id FROM user_profiles WHERE user_id = ?', [req.userId], (err, results) => {
        if (err) {
...
profile.get('/smoke-drink', verifyUser_1.verifyUser, (req, res) => {
    db_1.db.query('SELECT smoke_id, drink_id FROM user_profiles WHERE user_id = ?', [req.userId], (err, results) => {
        if (err) {
            console.error('Error fetching kids-family:', err);
            return res.status(500).json({ message: 'Internal Server Error' });
        }
...
profile.post('/update-want-kids', verifyUser_1.verifyUser, [
    ...
    db_1.db.query(updateQuery, [want_kid_id, userId], (err, results) => {
        if (err) {
...
profile.post('/update-have-kids', verifyUser_1.verifyUser, [
    ...
    db_1.db.query(updateQuery, [have_kid_id, userId], (err, results) => {
        if (err) {
...
profile.post('/update-smoke', verifyUser_1.verifyUser, [
    ...
    db_1.db.query(updateQuery, [smoke_id, userId], (err, results) => {
        if (err) {
...
profile.post('/update-drink', verifyUser_1.verifyUser, [
    ...
    db_1.db.query(updateQuery, [drink_id, userId], (err, results) => {
        if (err) {
...
profile.get('/personality-options', (req, res) => {
...
profile.get('/personalities', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
...
profile.post('/personality', verifyUser_1.verifyUser, (req, res) => {
...
profile.get('/questions', (req, res) => {
    db_1.db.query('SELECT id, text as question FROM questions', (err, results) => {
        if (err) {
...
profile.get('/questionss', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    const sql = `
    SELECT 
        q.id AS question_id,
...
profile.post('/answer/:questionId', verifyUser_1.verifyUser, (req, res) => {
...
profile.get('/answer/:questionId', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    const questionId = req.params.questionId;
...
profile.get('/answers/count', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
...
profile.get('/questionanswer', (req, res) => {
    const userId = req.userId;
    const sql = `
      SELECT 
          qa.question_id,
...
profile.put('/updatestatus', verifyUser_1.verifyUser, (req, res) => {
    ...
    const updateStatusSql = `
      ...
      WHERE id = ?
  `;
    db_1.db.query(updateStatusSql, [approval, userId], (err, result) => {
        if (err) {
...
profile.get('/latestrejection', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    const query = `
...
profile.get('/UpdateRejectReason', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    const query = `
    SELECT rr.reason, r.created_at
...
profile.put('/deleteLatestRejectReason', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
    ...
    LIMIT 1
  `;
    db_1.db.query(findLatestReasonQuery, [userId], (err, results) => {
        if (err) {
            console.error('Error fetching latest rejection reason:', err);
            return res.status(500).json({ message: 'Internal Server Error' });
        }
      ...
      WHERE id = ?
    `;
        db_1.db.query(softDeleteReasonQuery, [notificationId], (err, result) => {
            if (err) {
...
profile.post("/media", verifyUser_1.verifyUser, upload.fields([
...
profile.post("/mediaupdate", verifyUser_1.verifyUser, upload.fields([
    { name: 'main', maxCount: 1 },
    { name: 'first', maxCount: 1 },
    { name: 'second', maxCount: 1 },
]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
profile.get('/media', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
...
profile.put('/updatestatusagain', verifyUser_1.verifyUser, (req, res) => {
    const userId = req.userId;
  ...
  `;
    ...
    db_1.db.query(updateStatusSql, [userId], (err, result) => {
        if (err) {
